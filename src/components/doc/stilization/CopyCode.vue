...
<script setup>
  ...
  const cmIconColor = defineModel('cm-icon-color');
  const cmIconErrorColor = defineModel('cm-icon-error-color');
  const cmIconIsCopyColor = defineModel('cm-icon-is-copy-color');
</script>