...
<script setup>
  ...
  const cmCountBg = defineModel('cm-count-bg');
  const cmCountColor = defineModel('cm-count-color');
  const cmCountPadding = defineModel('cm-count-padding');
  const cmCountBorderRight = defineModel('cm-count-border-right');
</script>