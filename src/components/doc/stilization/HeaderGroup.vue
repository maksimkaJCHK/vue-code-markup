...
<script setup>
  ...
  const cmHeaderPadding = defineModel('cm-header-padding');
  const cmHeaderFontSize = defineModel('cm-header-font-size');
  const cmHeaderColor = defineModel('cm-header-color');
</script>